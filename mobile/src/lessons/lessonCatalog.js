...
// Step types: splash | comparison | your_numbers | apy_chart | quiz | cta
  ...
  "what-is-sol": {
    ...
    steps: [
      ...
      },
      {
        ...
        leftPoints: ["Controlled by a bank", "Transfers take days", "Closed on weekends", "Can be frozen"],
        rightEmoji: "◎",
        rightLabel: "SOL wallet",
        rightPoints: ["You control it", "Settles in <1 second", "24/7, always on", "No one can freeze it"],
      },
      {
        type: "your_numbers",
      ...
      },
      {
        ...
        explanation:
          "SOL covers \"gas\" fees. Without it you can't send tokens or interact with apps — but your assets stay safe.",
      },
      {
        type: "cta",
        emoji: "◎",
    ...
    steps: [
      {
        type: "splash",
        emoji: "🔒",
        title: "Staking = earning interest",
        subtitle:
          "When you stake SOL you lend it to validators who run the Solana network. In return they share rewards with you — automatically, every 2–3 days.",
      },
      {
        type: "comparison",
  ...
  "liquid-staking": {
    ...
    steps: [
      ...
      },
      {
        ...
        explanation:
          "The receipt token represents your staked SOL + accumulated rewards. Its price goes up over time.",
      },
      {
        type: "cta",
        emoji: "💧",
...
// Ordered list for the catalog display — matches LearnScreen LESSON_CATALOG ordering
export const LESSON_IDS_ORDERED = [
  "what-is-sol",
  "what-is-wallet",
  "what-is-transaction",
  "what-is-token",
